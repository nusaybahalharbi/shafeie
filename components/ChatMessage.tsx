  ...
  if (role === "user") {
    ...
    return (
      <div className="mb-5 flex justify-start animate-slide-up">
        <div className="max-w-[75%] rounded-2xl rounded-tr-sm border border-nur-gold/[0.18] bg-gradient-to-br from-nur-gold/[0.12] to-nur-gold/[0.06] px-5 py-3 font-body text-sm leading-relaxed text-nur-text" dir="auto">{displayContent}</div>
      </div>
    );
  }
