  ...
  return (
    <div className="mb-3 overflow-hidden rounded-2xl border border-d-border [.light_&]:border-l-border bg-d-card [.light_&]:bg-l-card shadow-lg shadow-black/5">
      <div className="px-6 pb-4 pt-5" dir="rtl">
        ...
        <p className="font-quran text-[18px] leading-[2.4] text-d-text [.light_&]:text-l-text">{fields.text}</p>
      </div>
      <div className="flex items-center gap-3 border-t border-d-border [.light_&]:border-l-border px-6 py-2.5 bg-d-gold-soft/50 [.light_&]:bg-l-gold-soft/50">
